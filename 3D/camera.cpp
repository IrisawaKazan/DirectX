...
void UpdateCamera(void)
{
	...
	//g_camera.posR.y += (pPlayer->pos.y - g_camera.posR.y) * 0.1f;
	g_camera.posR.z += (pPlayer->pos.z - g_camera.posR.z) * 0.1f;

	//g_camera.posV.x += (pPlayer->pos.x - g_camera.posV.x) * 0.1f;
	//g_camera.posV.y += (pPlayer->pos.y - g_camera.posV.y) * 0.1f;
	//g_camera.posV.z += (pPlayer->pos.z - g_camera.posV.z) * 0.1f;
